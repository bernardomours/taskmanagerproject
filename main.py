...
class Ui_TelaPrincipal(object):
    def setupUi(self, TelaPrincipal):
        ...
        TelaPrincipal.resize(850, 766)
        TelaPrincipal.setMaximumSize(QtCore.QSize(850, 766))
...
"}")
        ...
        self.page.setGeometry(QtCore.QRect(0, 0, 182, 639))
        ...
        self.page_2.setGeometry(QtCore.QRect(0, 0, 182, 639))
...
"}")
        ...
        self.tableWidget_menu_principal.setColumnCount(6)
